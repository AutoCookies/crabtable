export default {
    ...
    templates: {
        title: "表格模板",
        intro: "选择一种布局插入到当前选区。仅插入结构和表头，不包含数据。",
        insert: "插入",
        close: "关闭",
        emptyTable: "空白表格",
        emptyTableDesc: "空白网格",
        basicTable: "基础表格",
        basicTableDesc: "6×10 表格，首行绿色",
        projectTasks: "项目任务跟踪",
        projectTasksDesc: "任务名称、负责人、状态、优先级、截止日",
        expenseTracker: "费用跟踪",
        expenseTrackerDesc: "日期、分类、说明、金额",
        clientContacts: "客户联系人",
        clientContactsDesc: "公司、联系人、邮箱、电话",
        timesheet: "考勤表",
        timesheetDesc: "工号、姓名、工作日、总工时",
        invoice: "发票模板",
        invoiceDesc: "项目、数量、单位、单价、合计",
        okrTracker: "OKR 目标跟踪",
        okrTrackerDesc: "目标、关键结果、指标、进度",
        contentCalendar: "内容日历",
        contentCalendarDesc: "发布日期、平台、标题、作者、链接",
        meetingMinutes: "会议纪要",
        meetingMinutesDesc: "议题、决议、行动项、负责人、截止日",
        eventSchedule: "活动日程",
        eventScheduleDesc: "开始/结束时间、活动、负责人、地点",
        simpleList: "简单列表",
        simpleListDesc: "项目和备注列",
        feedbackCollection: "收集反馈",
        feedbackCollectionDesc: "日期、反馈、分类、备注",
        expenseTracking: "分类支出",
        expenseTrackingDesc: "日期、描述、分类、金额",
        contactList: "联系人列表",
        contactListDesc: "姓名、邮箱、电话",
        taskList: "任务列表",
        taskListDesc: "任务、截止日期、状态",
        schedule: "日程表",
        scheduleDesc: "时间与工作日",
        inventory: "库存管理",
        inventoryDesc: "产品编码、名称、分类、库存、预警、单价",
    },
};
