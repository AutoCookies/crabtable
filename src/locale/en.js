export default {
    ...
    templates: {
        ...
        intro: "Choose a layout to insert at the current selection. No data is added—only structure and headers.",
        insert: "Insert",
        close: "Close",
        emptyTable: "Empty table",
        emptyTableDesc: "Blank grid",
        basicTable: "Basic table",
        basicTableDesc: "6×10 table, first row green",
        projectTasks: "Project Task Tracker",
        projectTasksDesc: "Task name, assignee, status, priority, due date",
        expenseTracker: "Expense Tracker",
        expenseTrackerDesc: "Date, category, description, amount",
        clientContacts: "Client Contact List",
        clientContactsDesc: "Company, contact person, email, phone",
        timesheet: "Employee Timesheet",
        timesheetDesc: "Emp ID, name, weekdays, total hours",
        invoice: "Invoice Template",
        invoiceDesc: "Item, qty, unit, unit price, total",
        okrTracker: "OKR / Goal Tracker",
        okrTrackerDesc: "Objective, key result, target, progress",
        contentCalendar: "Content Calendar",
        contentCalendarDesc: "Publish date, platform, title, author, link",
        meetingMinutes: "Meeting Minutes",
        meetingMinutesDesc: "Topic, decision, action, owner, deadline",
        eventSchedule: "Event Schedule",
        eventScheduleDesc: "Start/end time, activity, PIC, location",
        simpleList: "Simple list",
        simpleListDesc: "Item and notes columns",
        feedbackCollection: "Collect feedback",
        feedbackCollectionDesc: "Date, feedback, category, notes",
        expenseTracking: "Categorize expenses",
        expenseTrackingDesc: "Date, description, category, amount",
        contactList: "Contact list",
        contactListDesc: "Name, email, phone",
        taskList: "Task list",
        taskListDesc: "Task, due date, status",
        schedule: "Schedule",
        scheduleDesc: "Time and weekdays",
        inventory: "Inventory Management",
        inventoryDesc: "Item ID, name, category, in stock, reorder level, price",
    },
};
