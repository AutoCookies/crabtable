...
describe('Test clipboard', () => {
    ...
    describe('Copy cells of a worksheet with default styles', () => {
        it('worksheet has default style', async () => {
            ...
            const result = `<google-sheets-html-origin><table data-copy-id="${copyId}" xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="0" dir="ltr" style="table-layout:fixed;font-size:10pt;font-family:Arial;width:0px;border-collapse:collapse;border:none"><colgroup><col  width="88" /></colgroup>
