...
Overall, F&D is divided into many packages and works as plugins. This package (@crabtable/find-replace) provides the find and replace scheduling service, interface and UI, and the business packages (e.g. @crabtable/sheets-find-replace) provide specific search and replace logics.
...
What do business packages (e.g @crabtable/sheets-find-replace) do?
