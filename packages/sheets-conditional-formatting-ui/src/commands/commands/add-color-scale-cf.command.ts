...
import type { IAddConditionalRuleMutationParams, IColorScale, IConditionFormattingRule } from '@crabtable/sheets-conditional-formatting';
import {
    CommandType,
    ICommandService,
...
import { AddConditionalRuleMutation, CFRuleType, ConditionalFormattingRuleModel } from '@crabtable/sheets-conditional-formatting';
