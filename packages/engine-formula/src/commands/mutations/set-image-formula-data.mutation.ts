 ...
 */
export const SetImageFormulaDataMutation: IMutation<ISetImageFormulaDataMutationParams> = {
    id: 'formula.mutation.set-image-formula-data',
    type: CommandType.MUTATION,
    handler: (accessor: IAccessor, params: ISetImageFormulaDataMutationParams) => {
        return true;
    },
};
