...
export enum ImageSourceType {
    ...
    URL = 'URL',
    /**
     * The image source is a UUID, this ID is generated by the CrabTable image hosting service. For specific generation rules, please refer to the CrabTable image hosting service API documentation.
     */
    UUID = 'UUID',
    /**
