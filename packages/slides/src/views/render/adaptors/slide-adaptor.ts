...
import type { IColorStyle, IPageElement, ISlidePage } from '@crabtable/core';
import type { Engine } from '@crabtable/engine-render';
import { getColorStyle, Inject, Injector, PageElementType, SlideDataModel } from '@crabtable/core';
import { Rect, Scene, Slide, Viewport } from '@crabtable/engine-render';
