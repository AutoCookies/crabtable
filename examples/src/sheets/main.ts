...
import caES from '@crabtable/mockdata/locales/ca-ES';
import enUS from '@crabtable/mockdata/locales/en-US';
import esES from '@crabtable/mockdata/locales/es-ES';
import faIR from '@crabtable/mockdata/locales/fa-IR';
import frFR from '@crabtable/mockdata/locales/fr-FR';
import jaJP from '@crabtable/mockdata/locales/ja-JP';
import koKR from '@crabtable/mockdata/locales/ko-KR';
import ruRU from '@crabtable/mockdata/locales/ru-RU';
import skSK from '@crabtable/mockdata/locales/sk-SK';
import viVN from '@crabtable/mockdata/locales/vi-VN';
import zhCN from '@crabtable/mockdata/locales/zh-CN';
import zhTW from '@crabtable/mockdata/locales/zh-TW';
...
function createNewInstance() {
    ...
    // window.crabtableAPI.addFonts([
    //     { value: 'PingFang SC', label: '苹方（简）', category: 'sans-serif' },
    //     { value: 'Helvetica Neue', label: 'Helvetica Neue', category: 'sans-serif' },
    // ]);

    customRegisterEvent(univer, window.crabtableAPI!);
    // customRangePopups(univer, window.crabtableAPI!);
    simpleRangePopupDemo(univer, window.crabtableAPI!);
}
